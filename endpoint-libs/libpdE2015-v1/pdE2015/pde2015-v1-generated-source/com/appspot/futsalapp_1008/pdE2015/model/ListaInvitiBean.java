...
public final class ListaInvitiBean extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<Invito> listaInviti;

  static {
    // hack to force ProGuard to consider Invito used, since otherwise it would be stripped out
    // see http://code.google.com/p/google-api-java-client/issues/detail?id=528
    com.google.api.client.util.Data.nullOf(Invito.class);
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<Invito> getListaInviti() {
    return listaInviti;
  }
   ...
   */
  public ListaInvitiBean setListaInviti(java.util.List<Invito> listaInviti) {
