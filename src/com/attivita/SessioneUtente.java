...
public class SessioneUtente {
	...
	public static enum StatoSessione	{LOGIN_E_REGISTRAZIONE, LOGIN, REGISTRAZIONE,
										 ...
										 CAMPO, CREA_CAMPO, CREA_GRUPPO, EXIT, MODIFICA_GRUPPO,
	...
	private StatoSessione statoPrePrecedente = StatoSessione.STATO_SENTINELLA;
	...
	public StatoSessione getStatoPrePrecedente() {
		return statoPrePrecedente;
	}

	public void setStatoPrePrecedente() {
		this.statoPrePrecedente = StatoSessione.STATO_SENTINELLA;
	}
		...
		switch(nuovoStato)
		{
			...
			case GRUPPO:
				if(this.statoCorrente == StatoSessione.CREA_GRUPPO ||
				   ...
				   this.statoCorrente == StatoSessione.RICERCA_GRUPPO)
					this.statoPrecedente = StatoSessione.PRINCIPALE;
				else
					this.statoPrecedente = this.statoCorrente;
				break;
